...
import image2_1 from './image/2_1.png';
import image2_2 from './image/2_2.png';
import image3 from './image/3.png';
import image3_0 from './image/3_0.png';
import image3_1 from './image/3_1.png';
        ...
        {activeTab === 'screenshots' && (
          <section className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
              {[
                { src: image1, alt: "Job Listings" },
                { src: image2, alt: "Student Dashboard 1" },
                { src: image2_1, alt: "Student Dashboard 2" },
                { src: image2_2, alt: "Student Dashboard 3" },
                { src: image3, alt: "Employer Dashboard 1" },
                { src: image3_0, alt: "Employer Dashboard 2" },
                { src: image3_1, alt: "Employer Dashboard 3" },
                { src: image4, alt: "College Interface" }
              ].map((image, index) => (
                <div key={index} className="group relative overflow-hidden rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <img 
                    src={image.src} 
                    alt={image.alt} 
