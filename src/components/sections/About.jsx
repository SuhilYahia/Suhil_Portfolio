          ...
          <div className="w-full lg:w-1/2" dir="rtl">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 h-full">
              ...
              <div className="bg-[#eaeaea] dark:bg-[#23272f] rounded-2xl shadow-lg p-8 flex flex-col items-center border border-gray-100 dark:border-gray-700 h-full min-h-[120px]">
                ...
                <span className="text-gray-500 dark:text-gray-400 text-base text-center">2 Years </span>
              </div>
              {/* Completed Projects */}
              <div className="bg-[#eaeaea] dark:bg-[#23272f] rounded-2xl shadow-lg p-8 flex flex-col items-center border border-gray-100 dark:border-gray-700 h-full min-h-[120px]">
          ...
          <div className="w-full lg:w-1/2 h-full">
            <div className="bg-[#eaeaea] dark:bg-[#23272f] rounded-2xl shadow-lg p-8 h-full min-h-[220px] flex items-center">
              <p className="text-gray-700 dark:text-gray-200 text-lg leading-relaxed text-center w-full">
                I am a dedicated and detail-oriented Full Stack Developer with a strong background in designing, developing, and deploying modern, scalable, and responsive web applications. I am proficient in both front-end and back-end development, always striving to deliver reliable and innovative solutions.
              </p>
            </div>
          </div>
        </div>
